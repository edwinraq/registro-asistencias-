# Instrucciones para Agregar Vigilante

## Ejecuta estos comandos en phpMyAdmin:

1. Abre **phpMyAdmin** desde XAMPP
2. Selecciona la base de datos `registro_asistencia`
3. Ve a la pestaña **SQL**
4. Copia y pega este código:

```sql
-- Modificar tipo de usuario para incluir vigilante
...
## Credenciales del Vigilante:
- **Usuario:** vigilante
- **Contraseña:** 1234

## Funcionalidades del Panel Vigilante:
- ✅ Registrar entrada de instructores
- 🚪 Dar salida a instructores
